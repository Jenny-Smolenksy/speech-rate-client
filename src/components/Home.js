              ...
              <div class="container">
                 <div class="carousel-caption">
                    <div class="row">
                       <div class="col-md-6">
                          <div class="text-bg">
                             <span>How fast are you talking?</span>
                             <h1>Meassure</h1>
                             <p> Meassure speech rate by uploading sound file <br/> or record your own speech</p>
                             <a href="#">Record </a> <a href="contact.html">Upload file </a>
                          </div>
                       </div>
                       <div class="col-md-6">
                          <div class="text_img">
                             <figure><img src={require("./../assets/images/pct.png")} alt="#"/></figure>
                          </div>
                       </div>
                    </div>
                 </div>
