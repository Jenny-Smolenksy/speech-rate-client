    ...
    return (
        ...
        <div class="container">
           <div class="row d_flex">
              <div class="col-md-8">
                 <div class="titlepage">
                     <p>Hey! We are Almog and Jenny. <br/>
                     We are B.C.s students in Bar Ilan University at Computer Science faculty. <br/>
                     This app is part of our graduation final project. <br/>
                     In the project we trained Neural Network to identify vowels in Enlish speech. <br/>
                     For the training we used over 500 hours of speech, from libri-speech free data base. <br/>
